...
const typography: Record<ViewMode, TypographyConfig> = {
  architect: {
    ...
    p: 'text-base md:text-lg font-normal leading-relaxed',
  ...
  author: {
    ...
    h1: 'text-4xl md:text-6xl font-light tracking-tight text-balance',
    h2: 'text-2xl md:text-3xl font-light tracking-tight',
    h3: 'text-lg md:text-xl font-medium',
    p: 'text-base md:text-lg leading-loose',
  ...
  lab: {
    ...
    p: 'text-xs md:text-sm opacity-70 leading-relaxed',
